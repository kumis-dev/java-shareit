...
public class BookingController {
    ...
    public ResponseEntity<Object> approve(@RequestHeader(HttpHeaders.USER_ID) Long userId,
    ...
    @PostMapping
    public ResponseEntity<Object> bookItem(@RequestHeader(HttpHeaders.USER_ID) Long userId,
    ...
    public ResponseEntity<Object> getBooking(@RequestHeader(HttpHeaders.USER_ID) Long userId,
                                             @PathVariable Long bookingId) {
